...
[![CI](https://github.com/Abhiram-15/carbon-platform/actions/workflows/ci.yml/badge.svg)](https://github.com/Abhiram-15/carbon-platform/actions/workflows/ci.yml)
...
```bash
gcloud config set project carbon-platform-abhiram
...
gcloud run deploy carbon-platform \
    ...
    --set-env-vars PROJECT_ID=carbon-platform-abhiram,REGION=us-central1,USE_GEMINI=true,USE_FIRESTORE=true
